      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex space-x-8">
            ...
            <Link
              to="/itinerary"
              className={`font-semibold transition duration-300 ${location.pathname === '/itinerary' ? 'text-cyan-600 border-b-2 border-cyan-600' : 'text-gray-600 hover:text-cyan-500'}`}
            >
              My Itinerary
            </Link>
          </div>
